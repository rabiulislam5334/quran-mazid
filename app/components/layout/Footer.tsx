...
export function Footer() {
  return (
    <footer 
      className="border-t px-4 md:px-8 py-16 transition-colors duration-300"
    ...
    >
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-2">
          <Link href="/" className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10">
              <img src="/quran_mazid.png" alt="Logo" className="w-full h-full object-contain" />
            </div>
        ...
        {FOOTER_LINKS.map(({ title, links }) => (
          <div key={title}>
            <h4 className="text-[15px] font-bold mb-6 uppercase tracking-wider" style={{ color: "var(--text-primary)" }}>
              {title}
            </h4>
      ...
      <div className="max-w-[1400px] mx-auto mt-16 pt-8 border-t text-center md:text-left" style={{ borderColor: "var(--border)" }}>
